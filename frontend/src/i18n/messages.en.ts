...
export const en: Messages = {
  ...
  comparison: {
    ...
    back: '← Back',
    you: 'You',
    alignedHeading: 'Where you align',
    differHeading: 'Where you differ',
    summary: (aligned, total) => `You align on ${aligned} of ${total} shown dimensions.`,
    absentYou: 'This didn’t show strongly in your answers.',
    absentThem: otherLabel => `This didn’t show strongly in ${otherLabel}’s answers.`,
  },
  comparisonList: {
    heading: 'Your comparisons',
    empty: 'No comparisons yet. Invite someone to compare working styles.',
    pending: 'Waiting for them to join',
    unavailable: 'No longer available',
    open: 'View',
    loadError: 'Couldn’t load your comparisons.',
  },
  consentInvitee: {
